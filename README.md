...
1. Create a file in the `aws` directory called `terraform.tfvars` with the following content. Make sure to fill in the `...` values with your AWS account info and domain info.

   ```hcl
   str_aws_account_id = "..."
   str_aws_region     = "us-east-1"
